...
export const TECH_STACK = [
  ...
  { name: 'Gemini',     role: 'Embeddings + generation', why: '3072-dim embeddings (gemini-embedding-001) + gemini-2.0-flash for answers',                           color: 'text-violet-400 bg-violet-500/10 border-violet-500/20' },
